...
from GPT2_config import GPT_CONFIG_124M, GPT_CONFIG


a = GPT_CONFIG.vocab_size
...
class GPTModel(nn.Module):
    ...
    """
    def __init__(self, cfg: GPT_CONFIG): # receives a dictionary with the configuration
        super().__init__()
        # 1.1
